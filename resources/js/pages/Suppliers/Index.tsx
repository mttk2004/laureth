    ...
    const columns = [
        {
            ...
            render: (supplier: Supplier) => <div className="text-sm font-medium">{supplier.name}</div>,
        },
        {
            key: 'phone',
            label: 'Số điện thoại',
            render: (supplier: Supplier) => <div className="text-sm">{formatPhoneNumber(supplier.phone)}</div>,
        },
        {
            key: 'email',
            label: 'Email',
            render: (supplier: Supplier) => <div className="text-sm">{supplier.email}</div>,
        },
    ];
            ...
            <div>
                <div className="mb-6 flex items-center justify-between">
                    ...
                    <div className="flex space-x-2">
                        <SupplierSortSelect value={sort as SupplierSortOption} onChange={handleSortChange} />
                        <SupplierFilters initialFilters={filters} onApplyFilters={handleApplyFilters} />
                ...
                <SupplierDetailDialog supplier={selectedSupplier} open={detailDialogOpen} onOpenChange={setDetailDialogOpen} />

                <DeleteSupplierDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen} onConfirm={handleDelete} />
            </div>
        </AppLayout>
    );
}
