...
import { PayrollSortOptionLabels, PayrollStatus } from '@/types/payroll';
        ...
        <div className="flex items-center gap-2">
            ...
            <Dialog open={isFilterOpen} onOpenChange={setIsFilterOpen}>
                <DialogTrigger asChild>
                    <Button variant="outline" className="flex h-10 items-center gap-2 px-4" size="default">
                        <Filter className="h-4 w-4" />
                        <span>Lọc lương</span>
                        {hasActiveFilters && <span className="bg-primary flex h-2 w-2 rounded-full"></span>}
                    </Button>
                </DialogTrigger>
                <DialogContent className="max-w-md">
                    <DialogHeader>
                        <DialogTitle>Lọc bảng lương</DialogTitle>
                        <DialogDescription>Lọc danh sách bảng lương theo các tiêu chí bên dưới</DialogDescription>
                    </DialogHeader>
            ...
            <Select value={sort} onValueChange={handleSortChange}>
                <SelectTrigger className="flex h-10 w-48 items-center">
                    <div className="flex items-center gap-2">
