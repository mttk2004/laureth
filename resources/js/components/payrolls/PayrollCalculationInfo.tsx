    ...
    return (
        <HoverCard>
            <HoverCardTrigger asChild>
                <div className={`flex cursor-help items-center ${className || ''}`}>
            ...
            <HoverCardContent className="w-80 p-4">
                <div className="space-y-3">
                    ...
                    <div className="space-y-2 text-sm">
                        ...
                        <p className="text-muted-foreground">Lương cơ bản + Hoa hồng doanh số cửa hàng</p>
                    ...
                    <div className="space-y-2 text-sm">
                        ...
                        <p className="text-muted-foreground">(Lương theo giờ × Số giờ làm việc) + Hoa hồng từ bán hàng</p>
                        <ul className="text-muted-foreground ml-2 list-inside list-disc">
