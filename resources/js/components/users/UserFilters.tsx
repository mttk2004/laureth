        ...
        >
            <BaseFilterForm>
                <BaseFilterRow label="Tên">
                    <Input placeholder="Nhập tên nhân viên" name="name" value={filters.name} onChange={handleInputChange} />
                </BaseFilterRow>

                <BaseFilterRow label="Vị trí">
                    <Select value={filters.position} onValueChange={(value) => handleSelectChange('position', value)}>
