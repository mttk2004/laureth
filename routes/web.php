...
// Payroll PDF
Route::get('/payroll/pdf/latest', [PayrollPdfController::class, 'downloadLatest'])->middleware(['auth']);
Route::get('/payroll/pdf/{payrollId}', [PayrollPdfController::class, 'download'])->middleware(['auth']);

// Payroll History
Route::get('/payroll/history', [PayrollController::class, 'history'])->middleware(['auth'])->name('payroll.history');
Route::get('/api/payroll/history', [PayrollController::class, 'getUserPayrollHistory'])->middleware(['auth']);
