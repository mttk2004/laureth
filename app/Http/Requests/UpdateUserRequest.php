...
class UpdateUserRequest extends FormRequest
{
    ...
    {
        // Chỉ DM (quản lý chuỗi) mới có quyền cập nhật người dùng
    ...
    {
        // Lấy userId từ route parameter 'user' thay vì 'userId'
        $userId = $this->route('user');
        Log::info('userId để cập nhật người dùng: ', ['userId' => $userId]);
    ...
    protected function prepareForValidation()
    {
        ...
        if ($this->has('commission_rate') && $this->commission_rate !== null && $this->commission_rate !== '') {
            $this->merge([
